        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/lamparasindustriales_neiva" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-neutral-800 hover:bg-brand-600 rounded-full flex items-center justify-center transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://wa.me/573013991153" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {FOOTER_CATEGORIES.map((item) => (
                <li key={item.label}>
                  <Link href={item.href} className="text-neutral-400 hover:text-brand-400 transition-colors text-sm">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-neutral-400">
              <p>
                ...
                <br />
                <a href="https://wa.me/573013991153" className="text-brand-400 hover:text-brand-300">
                  +57 301 399 1153
                </a>
              </p>
              <p>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-neutral-400">
          <div className="flex flex-wrap gap-4 justify-center sm:justify-start">
            {FOOTER_TERMS.map((item) => (
              <Link key={item.label} href={item.href} className="hover:text-brand-400 transition-colors">
                {item.label}
              </Link>
            ))}
          </div>
